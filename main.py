...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
     rules = (
         ...
         "❗️ Голосує спільнота — РІШЕННЯ ЗАВЖДИ ЗА ТОБОЮ — бот не несе відповідальності за наслідки голосування. Ми не даємо юридичних, фінансових чи медичних порад.\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        ...
        "⚠️ Дислеймер:\n"
        "  Голосує спільнота — РІШЕННЯ ЗАВЖДИ ЗА ТОБОЮ — бот не несе відповідальності за наслідки голосування. Ми не даємо юридичних, фінансових чи медичних порад.\n\n"
