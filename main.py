...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
     rules = (
         ...
         "📝 Правила:\n"
         "  • Надсилай лише законні та етичні дилеми.\n"
         "  • Заборонено спам, рекламу і образи.\n"
         "  • Дилеми проходять модерацію перед публікацією.\n\n"
         "❗️ Усі рішення приймає спільнота — бот не несе відповідальності за наслідки.\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        ...
        "📝 Правила:\n"
        "  • Надсилай лише законні й етичні дилеми.\n"
        "  • Без спаму, реклами чи образ.\n"
        "  • Усі дилеми проходять модерацію.\n\n"
        "⚠️ Дислеймер:\n"
        "  Бот не несе відповідальності за наслідки голосувань.\n\n"
